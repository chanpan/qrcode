...
$this->title = Yii::t('app', 'Systemlogs');
...
<div class="box box-primary">
    <div class="box-header">
         ...
         <div class="pull-right">
             <?= Html::button(SDHtml::getBtnAdd(), ['data-url'=>Url::to(['systemlog/create']), 'class' => 'btn btn-success btn-sm', 'id'=>'modal-addbtn-systemlog']). ' ' .
...
$('#systemlog-grid-pjax').on('dblclick', 'tbody tr', function() {
    ...
    modalSystemlog('<?= Url::to(['systemlog/update', 'id'=>''])?>'+id);
});	
